...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        if ( empty($id) || empty($name) || empty($email) || empty($phone) || empty($address) || empty($pickup_date) ) {
           $errorMessage = "ALL the fields are required";
           break;
        }

        $sql = "UPDATE request " . 
               "SET name = '$name', email = '$email', phone = '$phone', address = '$address', pickup_date = '$pickup_date' " . 
               "WHERE id = $id";
            ...
            <form method="POST">
                ...
                <div class="form">
                    ...
                    <div class="inputfield">
                        <button type="submit" value="Add Client" class="btn">Update Client</button><a href="admin.php" type="submit" value="Cancel" class="btn">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
